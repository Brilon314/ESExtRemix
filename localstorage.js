...
var LOCAL_CLAN = "Clan";
var LOCAL_COMERCIO = "Comercio";
var LOCAL_RECSMS = "RecSMS";

var LOCAL = {
  clean: function() {
    for (var key in localStorage) {
      if (key == LOCAL_ASEDIOS || key == LOCAL_FORMACIONES || key == LOCAL_ATACAR) continue;
  ...
  setAsedio: function(asedio) {
    ...
    if (localStorage[LOCAL_ASEDIOS] == undefined && localStorage[LOCAL_ASEDIOS] == null) localStorage[LOCAL_ASEDIOS] = "[]";
    ...
    for (var i = 0; i < currentAsedios.length; i++) {
      if (currentAsedios[i].idCiudad == asedio.idCiudad && currentAsedios[i].partida == partida) {
        exists = true;
        if (new Date(currentAsedios[i].fecha) <= new Date(asedio.fecha)) newAsedios.push(asedio);
  ...
  getAsedioByName: function(nombreCiudad) {
    ...
    for (var i = 0; i < currentAsedios.length; i++) {
      ...
      if (temp == nombreCiudad && currentAsedios[i].partida == partida) return currentAsedios[i];
    }
  },
  cleanAsedios: function() {
    if (localStorage[LOCAL_ASEDIOS] != undefined && localStorage[LOCAL_ASEDIOS] != null) var currentAsedios = JSON.parse(localStorage[LOCAL_ASEDIOS]);
    else return;
    var asediosMarcados = new Array();
    for (var i = 0; i < currentAsedios.length; i++) {
      if (currentAsedios[i].marcado) asediosMarcados.push(currentAsedios[i]);
    }
  ...
  getImperio: function() {
    if (localStorage[LOCAL_IMPERIO] == undefined || localStorage[LOCAL_IMPERIO] == null) return null;
    return JSON.parse(localStorage[LOCAL_IMPERIO]);
  },
  // Función para almacenar la información de comercio en localStorage
  setComercio: function(obj) {
    if (obj == undefined) return null;
    localStorage[LOCAL_COMERCIO] = JSON.stringify(obj);
    return obj;
  },
  // Función para obtener la información de comercio desde localStorage
  getComercio: function() {
    if (localStorage[LOCAL_COMERCIO] == undefined || localStorage[LOCAL_COMERCIO] == null) return null;
    return JSON.parse(localStorage[LOCAL_COMERCIO]);
  }, // Función para almacenar la información de comercio en localStorage
  setRecSMS: function(obj) {
    if (obj == undefined) return null;
    localStorage[LOCAL_RECSMS] = JSON.stringify(obj);
    return obj;
  },
  getRecSMS: function() {
    if (localStorage[LOCAL_RECSMS] == undefined || localStorage[LOCAL_RECSMS] == null) return null;
    return JSON.parse(localStorage[LOCAL_RECSMS]);
  },
  ...
  getCiudad: function() {
    if (localStorage[LOCAL_CIUDADES] == undefined || localStorage[LOCAL_CIUDADES] == null) return null;
  ...
  getProduccion: function() {
    if (localStorage[LOCAL_PRODUCCION] == undefined || localStorage[LOCAL_PRODUCCION] == null) return null;
  ...
  getHeroe: function() {
    if (localStorage[LOCAL_HEROES] == undefined || localStorage[LOCAL_HEROES] == null) return null;
  ...
  getRecurso: function() {
    if (localStorage[LOCAL_RECURSO] == undefined || localStorage[LOCAL_RECURSO] == null) return null;
  ...
  getFormaciones: function() {
    if (localStorage[LOCAL_FORMACIONES] == undefined || localStorage[LOCAL_FORMACIONES] == null) return null;
  ...
  getPacifico: function() {
    if (localStorage[LOCAL_PACIFICO] == undefined || localStorage[LOCAL_PACIFICO] == null) return null;
  ...
  getAtaques: function() {
    if (localStorage[LOCAL_ATACAR] == undefined || localStorage[LOCAL_ATACAR] == null) return null;
  ...
  getEficiencia: function() {
    if (localStorage[LOCAL_EFICIENCIA] == undefined || localStorage[LOCAL_EFICIENCIA] == null) return null;
  ...
  getCarga: function() {
    if (localStorage[LOCAL_CARGA] == undefined || localStorage[LOCAL_CARGA] == null) return null;
  ...
  getCanjes: function() {
    if (localStorage[LOCAL_CANJES] == undefined || localStorage[LOCAL_CANJES] == null) return null;
